jQuery(function ($) {
    ...
    function wa_load_posts(me) {
        ...
        data = {
            'action': 'loadmore',
            'page': tp_loadmore_params.current_page,
            'options': options,
            'cat': cat,
            'dir': dir,
        };
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data) {
                    ...
                    if (dir === 'nxt' || dir === 'more') {
                        tp_loadmore_params.current_page++;
                    }
                    ...
                    button.attr('data-cpag', tp_loadmore_params.current_page);

                    if (tp_loadmore_params.current_page <= 1) {
                        disabled.addClass('disabled');
                    } else {
                        disabled.prev().removeClass('disabled');
                    }

                    if (tp_loadmore_params.current_page == max_paged) {
                        disabled.addClass('disabled');
                    } else {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data) {
                    ...
                    tp_loadmore_params.current_page = '1';
