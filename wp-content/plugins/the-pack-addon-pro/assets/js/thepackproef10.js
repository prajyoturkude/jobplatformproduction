(function ($) {
    ...
    var TpMarquee = function ($scope, $) {
        $scope.find('.tp-marquee').each(function () {
            $(this).find('.marquee').marquee();   
        });
    };

    var TpVerticalCase = function ($scope, $) {
        $scope.find('.thepack-vcase-accordion').each(function () {
    ...
    $(window).on('elementor/frontend/init', function () {
        ...
        var widgets = {
            ...
            'tb_marquee': TpMarquee,
            'tpvcase': TpVerticalCase,
        };
